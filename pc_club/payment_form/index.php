        ...
        <div class="card-display">
            <div class="card">
                <div class="logo-cards">
                    ...
                    <div>
                        <div>
                            <img src="img/card-type/mastercard.png" class="brand" alt="Card Brand" id="card-brand">
                            <img src="img/card-type/visa.png" class="brand" alt="Card Brand" id="card-brand">
                            <img src="img/card-type/discover.png" class="brand" alt="Card Brand" id="card-brand">
                            <img src="img/card-type/amex.png" class="brand" alt="Card Brand" id="card-brand">    
                        </div>
                    </div>
                </div>
